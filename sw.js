const CACHE="lander-controle-v117";
const ASSETS=["./","./index.html","./manifest.json","./lander-bg.jpeg","./icon.svg","./apple-touch-icon.png","./icon-192.png","./icon-512.png","./icon-1024.png"];
